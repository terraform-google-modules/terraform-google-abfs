...
| <a name="input_abfs_gerrit_uploader_manifest_scheme"></a> [abfs\_gerrit\_uploader\_manifest\_scheme](#input\_abfs\_gerrit\_uploader\_manifest\_scheme) | The manifest scheme to assume | `string` | `"https"` | no |
