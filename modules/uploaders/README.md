...
| <a name="input_abfs_secret_replication_locations"></a> [abfs\_secret\_replication\_locations](#input\_abfs\_secret\_replication\_locations) | A list of Google Cloud regions to replicate the Secret Manager secrets to. If empty, automatic replication is used. | `list(string)` | `[]` | no |
...
| <a name="input_region"></a> [region](#input\_region) | Region for ABFS servers | `string` | n/a | yes |
