...
| abfs\_server\_cos\_image\_ref | Reference to the COS boot image to use for the ABFS server | `string` | `"projects/cos-cloud/global/images/family/cos-125-lts"` | no |
...
| abfs\_spanner\_instance\_max\_nodes | The maximum number of nodes in the Spanner instance. | `number` | `10` | no |
| abfs\_spanner\_instance\_min\_nodes | The minimum number of nodes in the Spanner instance. | `number` | `1` | no |
...
| Name | Description |
|------|-------------|
| abfs\_bucket\_name | The ABFS GCS bucket name |
