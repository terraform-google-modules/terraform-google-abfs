...
| <a name="input_abfs_spanner_instance_max_nodes"></a> [abfs\_spanner\_instance\_max\_nodes](#input\_abfs\_spanner\_instance\_max\_nodes) | The maximum number of nodes in the Spanner instance. | `number` | `10` | no |
| <a name="input_abfs_spanner_instance_min_nodes"></a> [abfs\_spanner\_instance\_min\_nodes](#input\_abfs\_spanner\_instance\_min\_nodes) | The minimum number of nodes in the Spanner instance. | `number` | `1` | no |
